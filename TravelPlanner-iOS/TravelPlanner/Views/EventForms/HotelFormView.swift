...
struct HotelFormView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Dates") {
                MinuteIntervalDatePicker(title: "Check-in", date: $checkInDate)
                MinuteIntervalDatePickerRange(title: "Check-out", date: $checkOutDate, bounds: checkInDate...Date.distantFuture)
            }
